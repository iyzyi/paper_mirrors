"""
Used by iyzyi from https://gist.github.com/Erreinion/6691093
...
def GetHtmlAndSource():
    '''
    Add by iyzyi for the project of paper_mirrors.
    '''
    cb = HtmlClipboard()
    if cb.HasHtmlFormat():
        return cb.GetSource(), cb.GetFragment()
    else:
        return None, None
